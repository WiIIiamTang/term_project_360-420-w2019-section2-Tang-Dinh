module.exports = {
    getAccuracy: function(labels, predictedLabels){
        var good = 0;
        var total = 0;
    ...
    confusionMatrix: function(labels, predictedLabels){
    ...
    getBaselineAcc: function(labels){
        var one = 0;
        var zero = 0;
        var mostFreq = 0;
    ...
    mcFaddenRSquared: function(x, labels, beta){
        var rSquare = 0;
        var ones = 0;
        var zeroes = 0;
        var overallProb = 0;
        ...
        logLikeliOverall = logLikelihood(x, labels, overallBeta);
        logLikeliModel = logLikelihood(x, labels, beta);
